...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Force the SurfaceView to fill the whole window. Without explicit params it
        // gets default WRAP_CONTENT in a RelativeLayout, so the fixed-size 720p buffer
        // (set in SDLSurface) is NOT stretched to the panel and leaves black borders.
        // MATCH_PARENT makes SurfaceFlinger upscale the 720p buffer to true fullscreen.
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public SDLSurface(Context context) {
        ...
        // OUYA: render the GL surface at a fixed 720p buffer and let SurfaceFlinger
        // upscale it to fill the whole TV panel. Two wins at once:
        //   - true fullscreen output regardless of the panel's overscan-safe frame
        //     (the OUYA otherwise hands us a ~1728x892 content surface = letterbox feel)
        //   - ~40% fewer fragments than native 1080p/1.5MP => keeps the Tegra 3
        //     GPU (fill-bound) comfortably above 50 fps.
