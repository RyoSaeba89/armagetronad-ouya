...
//        else
    ...
    private void initializeBluetooth() {
        ...
        // OUYA is API 16; android.bluetooth.BluetoothManager only exists since API 18.
        // SDL 2.0.14 calls this unconditionally -> NoClassDefFoundError on Jelly Bean.
        if (android.os.Build.VERSION.SDK_INT < 18) {
            Log.d(TAG, "Skipping Bluetooth init on API < 18 (OUYA)");
            return;
        }
