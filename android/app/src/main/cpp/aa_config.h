...
// Disable Armagetron's custom memory manager: its malloc/free/new MACROS collide
// with std::free etc. in boost headers. Bionic's allocator is fine on Android.
...
// --- install path macros (normally set by autotools; used by tDirectories) ---
#define AA_DATADIR     "."
